...
- List of neutral loss tokens ('loss@xxx.xx') for the spectrum
...
- Check that loss tokens are formatted consistently as 'loss@xxx.xx' with exactly 2 decimal places, matching the precision of peak tokens.
...
- [methods] In addition to all peaks of a spectrum, neutral losses between 5.0 and 200.0 Da were added as "loss@xxx.xx". Neutral losses are calculated as precursor − peak: "neutral losses between 5.0 and 200.0 Da were added as "loss@xxx.xx". Neutral losses are calculated as precursor − peak"
