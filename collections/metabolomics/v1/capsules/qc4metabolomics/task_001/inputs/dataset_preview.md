### `figures/manual_contaminants_poster.svg`
_binary file, 133 bytes_

### `figures/qrcode_poster.svg`
_binary file, 130 bytes_

### `figures/qrcode_preprint.svg`
_binary file, 130 bytes_

### `figures/trp_settings.png`
_binary file, 23138 bytes_

### `figures/warning_demo.png`
_binary file, 21240 bytes_

### `paper.md`
```
# stanstrup__QC4Metabolomics
...
* add release and semantic release ([c869a78](https://github.com/stanstrup/QC4Metabolomics/commit/c86
…[truncated]
```
