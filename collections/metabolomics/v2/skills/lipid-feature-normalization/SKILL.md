...
description: Use when after raw lipidomic and metabolomic data files have been generated
  by the Multi-ABLE method and loaded into the R environment, but before performing
  multivariate statistical analysis to identify differential lipids and metabolites.
license: CC-BY-4.0
metadata:
