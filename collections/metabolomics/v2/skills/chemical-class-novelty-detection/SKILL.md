...
description: Use when when you have CANOPUS chemical class predictions for your samples
  and need to identify which extracts contain chemical classes absent from the literature
  for their species or genus.
license: CC-BY-4.0
metadata:
