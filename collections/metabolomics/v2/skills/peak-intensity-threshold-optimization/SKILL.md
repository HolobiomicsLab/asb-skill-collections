...
description: Use when you have loaded raw mass spectrometry spectral data (in MGF,
  MSP, mzML, or mzXML format) and need to decide which intensity threshold(s) to use
  for filtering out noise and low-abundance peaks.
license: CC-BY-4.0
metadata:
