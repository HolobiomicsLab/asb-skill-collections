...
description: Use when you have a target compound (in SMILES or structure format) and
  need to predict what metabolites will form via environmental microbial biotransformation,
  including the reaction types and parent–product relationships.
license: CC-BY-4.0
metadata:
