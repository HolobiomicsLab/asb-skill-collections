...
description: Use when query mass spectra do not confidently match unmodified peptides
  in the spectral library, or when you suspect the sample contains unknown or unexpected
