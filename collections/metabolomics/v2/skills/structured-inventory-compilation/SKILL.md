...
description: Use when when you need to understand the modular composition of a multi-component
  research software project, particularly before onboarding, refactoring, or deploying
  it.
license: CC-BY-4.0
metadata:
