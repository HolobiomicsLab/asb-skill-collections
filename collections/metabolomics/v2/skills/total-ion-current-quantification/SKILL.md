...
description: Use when you have loaded a mass spectrometry imaging pixel array (NumPy
  format) and need to correct for variations in total ion signal across pixels before
  generating ion images or ratio images.
license: CC-BY-4.0
metadata:
