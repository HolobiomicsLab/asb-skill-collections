...
description: Use when after accurate mass searching has assigned multiple detected
  m/z features to the same metabolite via positive and negative adduct libraries,
  and before sample-level feature merging.
license: CC-BY-4.0
metadata:
