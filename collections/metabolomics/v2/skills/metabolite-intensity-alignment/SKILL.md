...
description: Use when you have raw lipidomic and metabolomic data files generated
  by the Multi-ABLE method (high-pressure liquid chromatography–mass spectrometry
  output) and need to prepare them for multivariate analysis to detect differential
  lipids and metabolites across biological samples (e.
license: CC-BY-4.0
metadata:
