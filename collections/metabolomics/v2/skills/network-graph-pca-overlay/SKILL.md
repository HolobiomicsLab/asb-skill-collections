...
description: Use when you have a sparse network graph generated by GLASSO and corresponding
  PCA scores from the same system, and you need to identify which regions or clusters
  of the network exhibit strong low-dimensional structure.
license: CC-BY-4.0
metadata:
