...
description: Use when after compound database dereplication (via SIRIUS or MetFrag)
  has produced per-spectrum candidate annotation lists with putative compound identifiers,
  and before applying selection criteria to rank and filter candidates.
license: CC-BY-4.0
metadata:
