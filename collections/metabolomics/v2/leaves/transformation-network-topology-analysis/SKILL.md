...
description: Use when when you have pre-processed FT-ICR MS peak lists with assigned
  molecular formulas and wish to move beyond univariate chemical composition analysis
  to understand metabolic transformation pathways and hub metabolites.
license: CC-BY-4.0
metadata:
