...
# numpy ships in the `analysis` extra, not the base install; without this the
# ImportError aborts collection of every other test module too.
np = pytest.importorskip("numpy", reason="install the `analysis` extra")
