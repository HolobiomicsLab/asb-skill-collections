"""Tests for the lexical core of the skill-matching engine (Task 1).

Serverless half only: skill_doc, lexical_match, match_tools, near_duplicates.
No network — these functions operate on in-memory index structures.
"""
import pathlib
import sys
