...
[![Zenodo DOI](https://img.shields.io/badge/Zenodo%20DOI-pending-lightgrey)](#attribution--citation)
...
- **Zenodo DOI:** not minted yet (`doi: TODO-zenodo`); the badge above is a
...
- **Zenodo DOI** — not minted yet (`TODO-zenodo`).
