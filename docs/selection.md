...
The behaviour described here was exercised on
`int/collections-release-2026-09-13` at `777671bc3`. It is the intended release
behaviour after the selector fixes are integrated; source revision `600f4a5dc`
predates them.
...
integration revision above. The `jq` projection keeps the real output readable.
