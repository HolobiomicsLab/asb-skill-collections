---
name: metabolomics-gc-ms-router
description: Use when a task needs a skill from ASB Metabolomics — GC-MS — search this unit's 367 evidence-grounded skills, then apply and optionally ground the one that fits.
license: CC-BY-4.0
metadata:
  skills_count: 367
  leaf_dir: leaves
...
# ASB Metabolomics — GC-MS — router

Entry point for **367 evidence-grounded skills**, each distilled from a
