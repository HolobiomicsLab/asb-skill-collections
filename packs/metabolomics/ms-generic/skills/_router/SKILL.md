---
name: metabolomics-ms-generic-router
description: Use when a task needs a skill from ASB Metabolomics — mass-spectrometry — search this unit's 804 evidence-grounded skills, then apply and optionally ground the one that fits.
license: CC-BY-4.0
metadata:
  skills_count: 804
  leaf_dir: leaves
