---
name: metabolomics-nmr-router
description: Use when a task needs a skill from ASB Metabolomics — NMR — search this unit's 276 evidence-grounded skills, then apply and optionally ground the one that fits.
license: CC-BY-4.0
metadata:
  skills_count: 276
  leaf_dir: leaves
...
# ASB Metabolomics — NMR — router

Entry point for **276 evidence-grounded skills**, each distilled from a
